    ...
    try {
        ...
        const classesData = [
            ...
            },
            {
                ...
                deadline: "2024-12-15",
                activityDetails: "Trabalho sobre a Revolução Francesa",
                profileImage: "http://example.com/image2.jpg",
            }
            // Adicione mais classes conforme necessário
        ];

        // Retorna status 200 e o JSON com os dados das classes
